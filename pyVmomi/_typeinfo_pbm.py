...
CreateDataType("pbm.profile.DissociateOp", "PbmProfileDissociateOp", "pbm.profile.ChangeAssociationOp", "pbm.version.version1", [("profile", "pbm.profile.ProfileId", "pbm.version.version1", F_OPTIONAL), ("hub", "pbm.placement.PlacementHub", "pbm.version.SpbmHubInDissociateOp", F_OPTIONAL)])
...
CreateEnumType("pbm.profile.CapabilityBasedProfile.SystemCreatedProfileType", "PbmSystemCreatedProfileType", "pbm.version.version2", ["VsanDefaultProfile", "VVolDefaultProfile", "PmemDefaultProfile", "VmcManagementProfile", "VsanPMemDefaultProfile", "VsanMaxDefaultProfile"])
