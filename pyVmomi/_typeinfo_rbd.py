...
AddVersion("rbd.version.RbdCustomHostCerts", "rbd1", "f9DE312E0", 0, "rbd1")
...
AddVersion("rbd.version.unstable", "rbd1", "u9DE312E0", 0, "rbd1")
...
AddVersionParent("rbd.version.RbdCustomHostCerts", "vmodl.query.version.version4")
AddVersionParent("rbd.version.RbdCustomHostCerts", "vmodl.query.version.version3")
AddVersionParent("rbd.version.RbdCustomHostCerts", "vmodl.query.version.version2")
AddVersionParent("rbd.version.RbdCustomHostCerts", "vmodl.query.version.version1")
AddVersionParent("rbd.version.RbdCustomHostCerts", "rbd.version.RbdCustomHostCerts")
AddVersionParent("rbd.version.RbdCustomHostCerts", "vmodl.version.version0")
AddVersionParent("rbd.version.RbdCustomHostCerts", "vmodl.version.version1")
AddVersionParent("rbd.version.RbdCustomHostCerts", "vmodl.version.version2")
AddVersionParent("rbd.version.RbdCustomHostCerts", "vmodl.reflect.version.version1")
AddVersionParent("rbd.version.RbdCustomHostCerts", "rbd.version.v7_0")
AddVersionParent("rbd.version.RbdCustomHostCerts", "rbd.version.version1")
AddVersionParent("rbd.version.RbdCustomHostCerts", "rbd.version.version3")
AddVersionParent("rbd.version.RbdCustomHostCerts", "rbd.version.version2")
AddVersionParent("rbd.version.RbdCustomHostCerts", "rbd.version.version5")
AddVersionParent("rbd.version.RbdCustomHostCerts", "rbd.version.version4")
AddVersionParent("rbd.version.RbdCustomHostCerts", "vim.version.version6")
AddVersionParent("rbd.version.RbdCustomHostCerts", "vim.version.version7")
AddVersionParent("rbd.version.RbdCustomHostCerts", "vim.version.version1")
AddVersionParent("rbd.version.RbdCustomHostCerts", "vim.version.version4")
AddVersionParent("rbd.version.RbdCustomHostCerts", "vim.version.version5")
AddVersionParent("rbd.version.RbdCustomHostCerts", "vim.version.version2")
AddVersionParent("rbd.version.RbdCustomHostCerts", "vim.version.version3")
...
AddVersionParent("rbd.version.unstable", "rbd.version.RbdCustomHostCerts")
...
AddVersionParent("rbd.version.disabled", "rbd.version.RbdCustomHostCerts")
...
ltsVersions.Add("rbd.version.v7_0")
dottedVersions.Add("rbd.version.v7_0")
...
CreateManagedType("rbd.CustomCertificateStore", "RbdCustomCertificateStore", "vmodl.ManagedObject", "rbd.version.RbdCustomHostCerts", None, [("addCertificate", "AddCertificate", "rbd.version.RbdCustomHostCerts", (("hostId", "string", "rbd.version.RbdCustomHostCerts", 0, None),("certificate", "string", "rbd.version.RbdCustomHostCerts", 0, None),("key", "string", "rbd.version.RbdCustomHostCerts", F_SECRET, None),("force", "boolean", "rbd.version.RbdCustomHostCerts", F_OPTIONAL, None),), (0, "void", "void"), "AutoDeploy.Rule.Create", ["rbd.fault.CustomCertificateExistsFault", "vmodl.fault.InvalidArgument", "rbd.fault.InvalidCertificateFault", ]), ("getCertificates", "GetCertificates", "rbd.version.RbdCustomHostCerts", (), (F_OPTIONAL, "rbd.CustomCertificateStore.CustomCertificateEntry[]", "rbd.CustomCertificateStore.CustomCertificateEntry[]"), None, None), ("removeCertificatesById", "RemoveCertificatesById", "rbd.version.RbdCustomHostCerts", (("certificateIds", "int[]", "rbd.version.RbdCustomHostCerts", F_OPTIONAL, None),), (0, "void", "void"), "AutoDeploy.Rule.Delete", None), ("removeCertificatesByHostId", "RemoveCertificatesByHostId", "rbd.version.RbdCustomHostCerts", (("hostIds", "string[]", "rbd.version.RbdCustomHostCerts", F_OPTIONAL, None),), (0, "void", "void"), "AutoDeploy.Rule.Delete", None)])
...
CreateDataType("rbd.fault.CustomCertificateExistsFault", "rbd1FaultCustomCertificateExistsFault", "vim.fault.ExtendedFault", "rbd.version.RbdCustomHostCerts", None)
...
CreateDataType("rbd.fault.InvalidCertificateFault", "rbd1FaultInvalidCertificateFault", "vim.fault.ExtendedFault", "rbd.version.RbdCustomHostCerts", None)
